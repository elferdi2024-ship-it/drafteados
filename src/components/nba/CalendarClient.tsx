...
export function CalendarClient({ initialGames, teams }: CalendarClientProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-[var(--hub-border)] bg-[var(--hub-surface)] p-4 sm:p-5 space-y-4 shadow-xl">
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs no-scrollbar border-t border-white/[0.04] pt-3">
          {[
      ...
      <div className="flex items-center justify-between text-xs font-mono text-[var(--hub-text-dim)] px-1">
        ...
        {(search || filterType !== "ALL" || selectedTeam !== "ALL") && (
          <button
            ...
            className="text-[var(--hub-accent)] hover:underline cursor-pointer"
          >
            Limpiar filtros
          </button>
        )}
