...
export const FOUNDERS: FounderItem[] = [
  ...
  },
  {
    ...
    handle: "@sergioandres",
    bio: "Comunicación directa, coberturas en pista en Estados Unidos y seguimiento de las franquicias de la NBA. Conecta a la comunidad con las historias, protagonistas y el debate del baloncesto.",
...
export const UNIVERSE_ITEMS: UniverseItem[] = [
  ...
  },
  {
    ...
    statusBadge: "SEMANAL",
    description: "El programa de referencia de la NBA en español.",
  ...
  },
  {
    ...
    statusBadge: "EXPEDICIONES",
    description: "Experiencias en cancha con la comunidad.",
    ctaText: "Viajar con nosotros",
    ...
    iconName: "Plane",
    stats: "Entradas NBA y backstage",
    accentColor: "#38BDF8",
    external: true,
  ...
  },
  {
    id: "nba-hub",
    title: "NBA Hub",
    badge: "Resultados y en vivo",
    statusBadge: "EN VIVO",
    description: "Marcadores, clasificación y calendario.",
    ctaText: "Entrar al Hub",
    ctaLink: "/nba",
    tag: "Resultados en Vivo",
    gradient: "from-[#FF5A1F]/30 via-orange-600/10 to-transparent",
    iconName: "Activity",
    stats: "Marcadores • Clasificación • Calendario",
    accentColor: "#FF5A1F",
    external: false,
